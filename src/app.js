...
// Use ntcadmin routes for API endpoints under /ntcadmin-service
app.use('/ntcadmin-service', ntcadminRoutes);  // This ensures that all ntcadmin routes are prefixed with /ntcadmin-service

// Sample route
app.get('/', (req, res) => {
  res.send('Welcome to the NTC Admin Service API!');
});
